...
public interface ITallerRepository : IRepositoryBase<Taller>
{
    ...
    Task<(ICollection<InscritosPorTallerInfo> Colecction, int Total)> ListAsync(int? instructorId, string? taller, int? situacion, DateOnly? fechaInicio, DateOnly? fechaFin, int pagina, int filas);
