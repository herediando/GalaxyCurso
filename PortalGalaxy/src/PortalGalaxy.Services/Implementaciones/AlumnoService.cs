...
public class AlumnoService : IAlumnoService
{
    ...
    public async Task<BaseResponse<ICollection<AlumnoDtoResponse>>> ListAsync(string? filtro, string? nroDocumento)
    {
        var response = new BaseResponse<ICollection<AlumnoDtoResponse>>();
    ...
    public async Task<BaseResponse<ICollection<AlumnoSimpleDtoResponse>>> ListSimpleAsync(string? filtro, string? nroDocumento)
    {
        var response = new BaseResponse<ICollection<AlumnoSimpleDtoResponse>>();
    ...
    public async Task<BaseResponse<AlumnoDtoResponse>> FindByIdAsync(int id)
    {

        var response = new BaseResponse<AlumnoDtoResponse>();
