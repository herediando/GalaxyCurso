...
public class InscripcionService : IInscripcionService
{
    ...
    public async Task<BaseResponse<InscripcionDtoRequest>> FindByIdAsync(int id)
    {
        var response = new BaseResponse<InscripcionDtoRequest>();
    ...
    public async Task<BaseResponse> AddMasivaAsync(InscripcionMasivaDtoRequest request)
    {
        ...
        try
        {
            ...
            {
                var alumno = await _alumnoRepository.FindAsync(id);
                if (alumno is null)
                {
                    response.ErrorMessage = "El alumno no existe";
                    return response;
